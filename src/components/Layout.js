    ...
    resources: {
      en: {
        translation: {
          ...
          "real estate consultant description":
            "Real Estate Consultant description",
          ...
          "university applications description":
            "university applications description",
          name: "Name",
          email: "Email",
          number: "Number",
          ...
          "we provide all consulting and legal services":
            "we provide all consulting and legal services regarding investing in turkey.",
          "bassin express": "bassin express",
          "bassin express description": "",
          "latest projects": "Our latest projects",
          "latest projects description":
            "you can view our latest projects that fits your needs",
          ...
          "sorry, no projects matching your search":
            "Sorry, no projects matching your search"
        }
      },
      ar: {
        translation: {
          ...
          "real estate consultant description":
            "نوفر فى شركة Homey خدمة الاستشارات العقارية عن طريق عرض مجموعة من المشاريع التى تتيح لعملائنا المقارنة فيما بينها واختيار المشروع المناسب لاحتياجاتهم وامكانياتهم سواء للسكن او للاستثمار ",
          "property managment": "إدارة العقار",
          "property managment description":
            "خدمة ادارة العقار  هى خدمة نقدمها فى شركة Homey لعملائنا المستثمريين حيث نقوم بادارة العقار عن طريق الاعلان عن العقار  البحث عن مستأجر وانهاء كافة الاجراءات القانونية وتحصيل العائد الشهري وايداعة فى حساب المالك بعد دفع الفواتير وايضا الاهتمام بالعناية الدورية بالعقار من ترميم وتجديد ونظافة",
          "legal process": "خدمات قانونية",
          "legal process description":
            "الاستشارات القانونية هى خدمة نقدمها لعملائنا تشمل انهاء كافة الامور القانونية المتعلقة بشراء العقار والحصول على الطابو والتقديم على الجنسية التركية . كما نساعد في توضيح الصورة كاملة عن طريق الاجابة على كافة الاسئلة والاستفسارات التى يحتاجها المستثمر حتى يستثمر بشكل امن وقانونى",
          "university applications": "قبولات جامعية",
          "university applications description":
            "خدمة القبولات الجامعية تعتبر  من اهم عناصر الاستقرار فى تركيا لذلك فى شركة Homey نوفر لكم كافة الخدمات في مجال القبولات الجامعية والدراسة في تركيا عن طريق مساعدتك ف تحضير  اوراقك وتوثيقها  وتجهيز الملف الخاص بك ومساعدتك فى تقديم اوراقك لدي الجامعات والحصول علي القبولات في المجالات التي ترغب في دراستها ",
          name: "الاسم",
          email: "الايميل",
          number: "الرقم",
          message: "الرسالة",
...
const TemplateWrapper = ({ children, locale, path }) => {
  ...
  return (
    <AppWrapper
      dir={locale === "ar" || locale === "pr" ? "rtl" : "ltr"}
      arabic={locale === "ar" ? true : false}
    >
      <Helmet>
        <html lang="en" />
        <title>{title}</title>
